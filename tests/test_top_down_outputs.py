...
def test_smoke_render_component():
    ...
    assetpack = AssetpackFactory.load('example_top_down')
    floor1 = assetpack.components['example_top_down.floor-2x2-exact']
...
def test_smoke_wall():
    ...
    """
    assetpack = AssetpackFactory.load('example_top_down')
    asset_id = 'example_top_down.double-floor-wall-exact'
...
def test_non_scaled_rendering():
    ...
    assetpack = AssetpackFactory.load('example_top_down')
    floor_1x1 = assetpack.components['example_top_down.floor-1x1-exact']
    ...
    prop_assetpack = AssetpackFactory.load('example_top_down_props')
    boxes = prop_assetpack.components['example_top_down_props.many-boxes']
...
def test_scaled_rendering():
    """Tests rescaling by rescaling a prop pack to match the projection
     of the floor pack."""
    assetpack = AssetpackFactory.load('example_top_down')
    prop_assetpack2 = AssetpackFactory.load('example_top_down_props')
    ...
    component_factory.add_component('many-boxes', 0, 0,
                                    assetpack_name='example_top_down_props')
