...
def test_old_tests():
    ...
    image_pixel_list7_3 = positioner.get_image_pixel_list(0, 0, image_location_list7_3)
    ...
    image_pixel_list7_2 = positioner2.get_image_pixel_list(-4, 5,
    ...
    image_pixel_list7_1 = positioner.\
