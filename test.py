...
image_location_list2=low_res_artpack.blueprints['floor_2x2_low_res'].get_image_location_list(1,1,low_res_artpack)
#toto: Why is this backwards?
renderer6=Renderer(image_pixel_list=positioner.get_image_pixel_list(500,0,image_location_list2))
renderer6.add_image_pixel_list(image_pixel_list=positioner.get_image_pixel_list(500,0,image_location_list))
renderer6.render()
